...
public class RegistroHuesped extends JFrame {
	...
	public String idReserva = views.Reservas.idReserva;
	...
	private void guardar() {
		if (txtNombre.getText() != null && txtApellido.getText() != null && txtFechaN.getDate() != null && txtNacionalidad.getSelectedItem().toString() != null && txtTelefono.getText() != null ) {
			...
			String fechaDeNacimiento = ((JTextField)txtFechaN.getDateEditor().getUiComponent()).getText();
			
			Huesped huesped = new Huesped(txtNombre.getText(), txtApellido.getText(), java.sql.Date.valueOf(fechaDeNacimiento), txtNacionalidad.getSelectedItem().toString(), Integer.parseInt(txtTelefono.getText()), idReserva);
			this.huespedController.guardar(huesped);
			JOptionPane.showMessageDialog(this, "Reserva guardada a su nombre! Muchas gracias y buena estadía!.");
